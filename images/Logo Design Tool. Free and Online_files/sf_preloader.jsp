...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!superfish.b.qsObj.dlsource) {
            superfish.b.qsObj.dlsource = "sfrvzr";
        }
...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        spsupport.events.init(jQuery);
            ...
            (function(){
                if(superfish.b.qsObj.userId != ''){
                    var url = "http://www.superfish.com/ws/sf_alive.jsp?dlsrc=" + superfish.b.qsObj.dlsource + "&uid=" + superfish.b.qsObj.userId;
                    ...
                    ifrm.setAttribute("style", "position:absolute; top:-20px; left:-20px;");//display:none");
